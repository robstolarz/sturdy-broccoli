...
if("TRUE" STREQUAL "TRUE")
  set(play_motion_msgs_SOURCE_PREFIX /root/tiago_public_ws/src/play_motion/play_motion_msgs)
  set(play_motion_msgs_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(play_motion_msgs_INSTALL_PREFIX /root/tiago_public_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'play_motion_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'play_motion_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/play_motion/play_motion_msgs/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
...
set(play_motion_msgs_EXPORTED_TARGETS "play_motion_msgs_generate_messages_cpp;play_motion_msgs_generate_messages_lisp;play_motion_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${play_motion_msgs_dep}_FOUND)
      find_package(${play_motion_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${play_motion_msgs_dep} REQUIRED ${depend_list})
  endif()
