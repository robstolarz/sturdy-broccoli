...
if("TRUE" STREQUAL "TRUE")
  set(run_motion_SOURCE_PREFIX /root/tiago_public_ws/src/tiago_tutorials/run_motion)
  set(run_motion_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(run_motion_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'run_motion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/tiago_tutorials/run_motion/${idir}'.  Ask the maintainer 'Jordi Pages <jordi.pages@pal-robotics.com>, Sammy Pfeiffer <sam.pfeiffer@pal-robotics.com>' to fix it.")
    endif()
