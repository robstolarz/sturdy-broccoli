...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /root/tiago_public_ws/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(controller_manager_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/ros_control/controller_manager/include;/usr/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/ros_control/controller_manager/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Wim Meeussen <wim@hidof.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_control/controller_manager/${idir}'.  Ask the maintainer 'Wim Meeussen <wim@hidof.com>' to fix it.")
    endif()
    _list_append_unique(controller_manager_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "controller_manager;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${controller_manager_dep}_FOUND)
      find_package(${controller_manager_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${controller_manager_dep} REQUIRED ${depend_list})
  endif()
