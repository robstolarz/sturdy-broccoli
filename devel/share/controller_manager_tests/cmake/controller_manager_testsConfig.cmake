...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /root/tiago_public_ws/src/ros_control/controller_manager_tests)
  set(controller_manager_tests_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(controller_manager_tests_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/ros_control/controller_manager_tests/include " STREQUAL " ")
  set(controller_manager_tests_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/ros_control/controller_manager_tests/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vijay Pradeep <vijay@hidof.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_control/controller_manager_tests/${idir}'.  Ask the maintainer 'Vijay Pradeep <vijay@hidof.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${controller_manager_tests_dep}_FOUND)
      find_package(${controller_manager_tests_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${controller_manager_tests_dep} REQUIRED ${depend_list})
  endif()
