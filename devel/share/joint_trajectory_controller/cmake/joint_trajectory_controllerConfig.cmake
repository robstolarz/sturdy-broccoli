...
if("TRUE" STREQUAL "TRUE")
  set(joint_trajectory_controller_SOURCE_PREFIX /root/tiago_public_ws/src/ros_controllers/joint_trajectory_controller)
  set(joint_trajectory_controller_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(joint_trajectory_controller_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/ros_controllers/joint_trajectory_controller/include " STREQUAL " ")
  set(joint_trajectory_controller_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/ros_controllers/joint_trajectory_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'joint_trajectory_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'joint_trajectory_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_controllers/joint_trajectory_controller/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
...
set(depends "actionlib;angles;roscpp;urdf;control_toolbox;controller_interface;hardware_interface;realtime_tools;control_msgs;trajectory_msgs;rostest;controller_manager;xacro")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${joint_trajectory_controller_dep}_FOUND)
      find_package(${joint_trajectory_controller_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${joint_trajectory_controller_dep} REQUIRED ${depend_list})
  endif()
