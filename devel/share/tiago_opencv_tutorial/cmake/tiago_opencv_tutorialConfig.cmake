...
if("TRUE" STREQUAL "TRUE")
  set(tiago_opencv_tutorial_SOURCE_PREFIX /root/tiago_public_ws/src/tiago_tutorials/tiago_opencv_tutorial)
  set(tiago_opencv_tutorial_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(tiago_opencv_tutorial_INSTALL_PREFIX /root/tiago_public_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tiago_opencv_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jordi Pages <jordi.pages@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'tiago_opencv_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/tiago_tutorials/tiago_opencv_tutorial/${idir}'.  Ask the maintainer 'Jordi Pages <jordi.pages@pal-robotics.com>' to fix it.")
    endif()
...
set(tiago_opencv_tutorial_EXPORTED_TARGETS "tiago_opencv_tutorial_generate_messages_cpp;tiago_opencv_tutorial_generate_messages_lisp;tiago_opencv_tutorial_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tiago_opencv_tutorial_dep}_FOUND)
      find_package(${tiago_opencv_tutorial_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tiago_opencv_tutorial_dep} REQUIRED ${depend_list})
  endif()
