...
if("TRUE" STREQUAL "TRUE")
  set(pal_gazebo_plugins_SOURCE_PREFIX /root/tiago_public_ws/src/pal_gazebo_plugins)
  set(pal_gazebo_plugins_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(pal_gazebo_plugins_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/pal_gazebo_plugins/include;/usr/include;/usr/include/gazebo-2.2;/usr/include/sdformat-1.4 " STREQUAL " ")
  set(pal_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/pal_gazebo_plugins/include;/usr/include;/usr/include/gazebo-2.2;/usr/include/sdformat-1.4")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pal_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/pal_gazebo_plugins/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Luca Marchionni <luca.marchionni@pal-robotics.com>' to fix it.")
    endif()
