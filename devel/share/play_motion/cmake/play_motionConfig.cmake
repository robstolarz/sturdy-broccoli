...
if("TRUE" STREQUAL "TRUE")
  set(play_motion_SOURCE_PREFIX /root/tiago_public_ws/src/play_motion/play_motion)
  set(play_motion_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(play_motion_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/play_motion/play_motion/include " STREQUAL " ")
  set(play_motion_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/play_motion/play_motion/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'play_motion' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Victor Lopez <victor.lopez@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'play_motion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/play_motion/play_motion/${idir}'.  Ask the maintainer 'Victor Lopez <victor.lopez@pal-robotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${play_motion_dep}_FOUND)
      find_package(${play_motion_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${play_motion_dep} REQUIRED ${depend_list})
  endif()
