...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_ros_control_SOURCE_PREFIX /root/tiago_public_ws/src/gazebo_ros_control)
  set(gazebo_ros_control_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(gazebo_ros_control_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/gazebo_ros_control/include " STREQUAL " ")
  set(gazebo_ros_control_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/gazebo_ros_control/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gazebo_ros_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>, Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gazebo_ros_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/gazebo_ros_control/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>, Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
...
set(depends "roscpp;controller_manager;pluginlib;transmission_interface;urdf")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${gazebo_ros_control_dep}_FOUND)
      find_package(${gazebo_ros_control_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gazebo_ros_control_dep} REQUIRED ${depend_list})
  endif()
