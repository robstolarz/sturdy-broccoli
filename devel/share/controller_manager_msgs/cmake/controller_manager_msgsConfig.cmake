...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_msgs_SOURCE_PREFIX /root/tiago_public_ws/src/ros_control/controller_manager_msgs)
  set(controller_manager_msgs_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(controller_manager_msgs_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_control/controller_manager_msgs/${idir}'.  Ask the maintainer 'Wim Meeussen <wim@hidof.com>' to fix it.")
    endif()
