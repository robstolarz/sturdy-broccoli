...
if("TRUE" STREQUAL "TRUE")
  set(joint_limits_interface_SOURCE_PREFIX /root/tiago_public_ws/src/ros_control/joint_limits_interface)
  set(joint_limits_interface_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(joint_limits_interface_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/ros_control/joint_limits_interface/include;/usr/include " STREQUAL " ")
  set(joint_limits_interface_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/ros_control/joint_limits_interface/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'joint_limits_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_control/joint_limits_interface/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
...
set(depends "roscpp;hardware_interface")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${joint_limits_interface_dep}_FOUND)
      find_package(${joint_limits_interface_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${joint_limits_interface_dep} REQUIRED ${depend_list})
  endif()
