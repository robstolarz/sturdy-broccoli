...
if("TRUE" STREQUAL "TRUE")
  set(rqt_controller_manager_SOURCE_PREFIX /root/tiago_public_ws/src/ros_control/rqt_controller_manager)
  set(rqt_controller_manager_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /root/tiago_public_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_control/rqt_controller_manager/${idir}'.  Ask the maintainer 'Kelsey Hawkins <kphawkins@gatech.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rqt_controller_manager_dep}_FOUND)
      find_package(${rqt_controller_manager_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rqt_controller_manager_dep} REQUIRED ${depend_list})
  endif()
