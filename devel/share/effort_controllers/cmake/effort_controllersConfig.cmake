...
if("TRUE" STREQUAL "TRUE")
  set(effort_controllers_SOURCE_PREFIX /root/tiago_public_ws/src/ros_controllers/effort_controllers)
  set(effort_controllers_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(effort_controllers_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/ros_controllers/effort_controllers/include " STREQUAL " ")
  set(effort_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/ros_controllers/effort_controllers/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'effort_controllers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vijay Pradeep <vijay@hidof.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'effort_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_controllers/effort_controllers/${idir}'.  Ask the maintainer 'Vijay Pradeep <vijay@hidof.com>' to fix it.")
    endif()
...
set(depends "controller_interface;control_msgs;control_toolbox;realtime_tools;urdf;forward_command_controller")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${effort_controllers_dep}_FOUND)
      find_package(${effort_controllers_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${effort_controllers_dep} REQUIRED ${depend_list})
  endif()
