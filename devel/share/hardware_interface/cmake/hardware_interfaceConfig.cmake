...
if("TRUE" STREQUAL "TRUE")
  set(hardware_interface_SOURCE_PREFIX /root/tiago_public_ws/src/ros_control/hardware_interface)
  set(hardware_interface_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(hardware_interface_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/ros_control/hardware_interface/include " STREQUAL " ")
  set(hardware_interface_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/ros_control/hardware_interface/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Wim Meeussen <wim@hidof.com>, Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_control/hardware_interface/${idir}'.  Ask the maintainer 'Wim Meeussen <wim@hidof.com>, Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${hardware_interface_dep}_FOUND)
      find_package(${hardware_interface_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hardware_interface_dep} REQUIRED ${depend_list})
  endif()
