...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /root/tiago_public_ws/src/ros_controllers/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/devel/include;/root/tiago_public_ws/src/ros_controllers/diff_drive_controller/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/devel/include;/root/tiago_public_ws/src/ros_controllers/diff_drive_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Bence Magyar <bence.magyar@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_controllers/diff_drive_controller/${idir}'.  Ask the maintainer 'Bence Magyar <bence.magyar@pal-robotics.com>' to fix it.")
    endif()
...
set(diff_drive_controller_EXPORTED_TARGETS "diff_drive_controller_generate_messages_cpp;diff_drive_controller_generate_messages_lisp;diff_drive_controller_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${diff_drive_controller_dep}_FOUND)
      find_package(${diff_drive_controller_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${diff_drive_controller_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "diff_drive_controller-msg-extras.cmake")
