...
if("TRUE" STREQUAL "TRUE")
  set(imu_sensor_controller_SOURCE_PREFIX /root/tiago_public_ws/src/ros_controllers/imu_sensor_controller)
  set(imu_sensor_controller_DEVEL_PREFIX /root/tiago_public_ws/devel)
  ...
  set(imu_sensor_controller_INSTALL_PREFIX /root/tiago_public_ws/install)
...
if(NOT "/root/tiago_public_ws/src/ros_controllers/imu_sensor_controller/include " STREQUAL " ")
  set(imu_sensor_controller_INCLUDE_DIRS "")
  set(_include_dirs "/root/tiago_public_ws/src/ros_controllers/imu_sensor_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'imu_sensor_controller' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'imu_sensor_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/tiago_public_ws/src/ros_controllers/imu_sensor_controller/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
...
set(depends "controller_interface;hardware_interface;sensor_msgs;realtime_tools")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${imu_sensor_controller_dep}_FOUND)
      find_package(${imu_sensor_controller_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${imu_sensor_controller_dep} REQUIRED ${depend_list})
  endif()
