...
class PersonDetections(genpy.Message):
  _md5sum = "2e9459d911994b1f8ae4e54431f0f631"
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.persons:
        ...
        _v2 = val1.face
        _x = _v2
        buff.write(_struct_4iB4i.pack(_x.x, _x.y, _x.width, _x.height, _x.eyesLocated, _x.leftEyeX, _x.leftEyeY, _x.rightEyeX, _x.rightEyeY))
        _v3 = _v2.position
        _x = _v3
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_f.pack(_v2.confidence))
        _x = _v2.expression
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        _x = _v2
        buff.write(_struct_8f.pack(_x.expression_confidence, _x.emotion_anger_confidence, _x.emotion_disgust_confidence, _x.emotion_fear_confidence, _x.emotion_happiness_confidence, _x.emotion_neutral_confidence, _x.emotion_sadness_confidence, _x.emotion_surprise_confidence))
        _v4 = val1.legs
        _v5 = _v4.header
        ...
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      _x = self
      buff.write(_struct_3I.pack(_x.camera_pose.header.seq, _x.camera_pose.header.stamp.secs, _x.camera_pose.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.camera_pose.transform.translation.x, _x.camera_pose.transform.translation.y, _x.camera_pose.transform.translation.z, _x.camera_pose.transform.rotation.x, _x.camera_pose.transform.rotation.y, _x.camera_pose.transform.rotation.z, _x.camera_pose.transform.rotation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.width, _x.height, _x.eyesLocated, _x.leftEyeX, _x.leftEyeY, _x.rightEyeX, _x.rightEyeY,) = _struct_4iB4i.unpack(str[start:end])
        ...
        if python3:
          _v18.name = str[start:end].decode('utf-8')
        else:
          _v18.name = str[start:end]
        start = end
        end += 4
        (_v18.confidence,) = _struct_f.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v18.expression = str[start:end].decode('utf-8')
        else:
          _v18.expression = str[start:end]
        _x = _v18
        start = end
        end += 32
        (_x.expression_confidence, _x.emotion_anger_confidence, _x.emotion_disgust_confidence, _x.emotion_fear_confidence, _x.emotion_happiness_confidence, _x.emotion_neutral_confidence, _x.emotion_sadness_confidence, _x.emotion_surprise_confidence,) = _struct_8f.unpack(str[start:end])
        _v20 = val1.legs
        _v21 = _v20.header
        start = end
        end += 4
        ...
        if python3:
          _v23.child_frame_id = str[start:end].decode('utf-8')
        else:
      ...
      (_x.camera_pose.header.seq, _x.camera_pose.header.stamp.secs, _x.camera_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.camera_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.camera_pose.child_frame_id = str[start:end].decode('utf-8')
      else:
        self.camera_pose.child_frame_id = str[start:end]
      _x = self
      start = end
      end += 56
      (_x.camera_pose.transform.translation.x, _x.camera_pose.transform.translation.y, _x.camera_pose.transform.translation.z, _x.camera_pose.transform.rotation.x, _x.camera_pose.transform.rotation.y, _x.camera_pose.transform.rotation.z, _x.camera_pose.transform.rotation.w,) = _struct_7d.unpack(str[start:end])
      return self
    ...
    try:
      ...
      for val1 in self.persons:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_f.pack(_v34.confidence))
        _x = _v34.expression
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v50.name = str[start:end].decode('utf-8')
        else:
          _v50.name = str[start:end]
        start = end
        end += 4
        (_v50.confidence,) = _struct_f.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v50.expression = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v55.child_frame_id = str[start:end].decode('utf-8')
        else:
