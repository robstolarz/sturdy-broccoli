...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sq'%length
      buff.write(struct.pack(pattern, *self.roi.x))
      length = len(self.roi.y)
      buff.write(_struct_I.pack(length))
      pattern = '<%sq'%length
      buff.write(struct.pack(pattern, *self.roi.y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.roi.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.roi.x = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sq'%length
      ...
      self.roi.y = struct.unpack(pattern, str[start:end])
      return self
