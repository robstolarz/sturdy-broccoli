...
class PersonDetection(genpy.Message):
  _md5sum = "348d9a2450d9fe1842079b742c10982b"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.face.expression_confidence, _x.face.emotion_anger_confidence, _x.face.emotion_disgust_confidence, _x.face.emotion_fear_confidence, _x.face.emotion_happiness_confidence, _x.face.emotion_neutral_confidence, _x.face.emotion_sadness_confidence, _x.face.emotion_surprise_confidence, _x.legs.header.seq, _x.legs.header.stamp.secs, _x.legs.header.stamp.nsecs,) = _struct_8f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
