...
class FaceDetection(genpy.Message):
  _md5sum = "a17fdb6b06e8f6a7b02b1e50262a787c"
...
"""
  ...
  __slots__ = ['x','y','width','height','eyesLocated','leftEyeX','leftEyeY','rightEyeX','rightEyeY','position','name','confidence','expression','expression_confidence','emotion_anger_confidence','emotion_disgust_confidence','emotion_fear_confidence','emotion_happiness_confidence','emotion_neutral_confidence','emotion_sadness_confidence','emotion_surprise_confidence']
  _slot_types = ['int32','int32','int32','int32','bool','int32','int32','int32','int32','geometry_msgs/Point32','string','float32','string','float32','float32','float32','float32','float32','float32','float32','float32']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4iB4i3f.pack(_x.x, _x.y, _x.width, _x.height, _x.eyesLocated, _x.leftEyeX, _x.leftEyeY, _x.rightEyeX, _x.rightEyeY, _x.position.x, _x.position.y, _x.position.z))
      _x = self.name
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.width, _x.height, _x.eyesLocated, _x.leftEyeX, _x.leftEyeY, _x.rightEyeX, _x.rightEyeY, _x.position.x, _x.position.y, _x.position.z,) = _struct_4iB4i3f.unpack(str[start:end])
