...
"""autogenerated by genpy from pal_common_msgs/DisableActionResult.msg. Do not edit."""
import sys
...
class DisableActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pal_common_msgs/DisableActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_common_msgs/DisableResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DisableActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_common_msgs.msg.DisableResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_common_msgs.msg.DisableResult()
