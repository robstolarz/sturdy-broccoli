...
"""autogenerated by genpy from pal_common_msgs/DisableAction.msg. Do not edit."""
import sys
...
import pal_common_msgs.msg
import std_msgs.msg

class DisableAction(genpy.Message):
  _md5sum = "f7cce8d83254ae8329a08eb10bcc1d92"
  _type = "pal_common_msgs/DisableAction"
...
"""
  ...
  _slot_types = ['pal_common_msgs/DisableActionGoal','pal_common_msgs/DisableActionResult','pal_common_msgs/DisableActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DisableAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pal_common_msgs.msg.DisableActionGoal()
      if self.action_result is None:
        self.action_result = pal_common_msgs.msg.DisableActionResult()
      if self.action_feedback is None:
        self.action_feedback = pal_common_msgs.msg.DisableActionFeedback()
    else:
      self.action_goal = pal_common_msgs.msg.DisableActionGoal()
      self.action_result = pal_common_msgs.msg.DisableActionResult()
      self.action_feedback = pal_common_msgs.msg.DisableActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_f3I.pack(_x.action_goal.goal.duration, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.duration, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
