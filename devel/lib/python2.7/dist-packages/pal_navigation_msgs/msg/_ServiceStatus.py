...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_Bf2IB.pack(_x.is_running, _x.update_frequency, _x.latest_run_time.secs, _x.latest_run_time.nsecs, _x.status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.serviceName = str[start:end].decode('utf-8')
      else:
        self.serviceName = str[start:end]
      _x = self
      start = end
      end += 14
      (_x.is_running, _x.update_frequency, _x.latest_run_time.secs, _x.latest_run_time.nsecs, _x.status,) = _struct_Bf2IB.unpack(str[start:end])
