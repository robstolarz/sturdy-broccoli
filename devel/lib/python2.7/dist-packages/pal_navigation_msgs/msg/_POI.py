...
"""autogenerated by genpy from pal_navigation_msgs/POI.msg. Do not edit."""
import sys
...
class POI(genpy.Message):
  _md5sum = "accd8dd07484c01aa4180821c83d7d4f"
  _type = "pal_navigation_msgs/POI"
...
"""
  __slots__ = ['points','ids','map_id']
  _slot_types = ['sensor_msgs/PointCloud','std_msgs/String[]','std_msgs/String']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(POI, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.map_id.data = str[start:end].decode('utf-8')
      else:
