...
"""autogenerated by genpy from pal_navigation_msgs/VisualTrainingAction.msg. Do not edit."""
import sys
...
class VisualTrainingAction(genpy.Message):
  _md5sum = "e4f61a9ec010e4c4596ca7372e044f24"
  _type = "pal_navigation_msgs/VisualTrainingAction"
...
"""
  ...
  _slot_types = ['pal_navigation_msgs/VisualTrainingActionGoal','pal_navigation_msgs/VisualTrainingActionResult','pal_navigation_msgs/VisualTrainingActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VisualTrainingAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pal_navigation_msgs.msg.VisualTrainingActionGoal()
      if self.action_result is None:
        self.action_result = pal_navigation_msgs.msg.VisualTrainingActionResult()
      if self.action_feedback is None:
        self.action_feedback = pal_navigation_msgs.msg.VisualTrainingActionFeedback()
    else:
      self.action_goal = pal_navigation_msgs.msg.VisualTrainingActionGoal()
      self.action_result = pal_navigation_msgs.msg.VisualTrainingActionResult()
      self.action_feedback = pal_navigation_msgs.msg.VisualTrainingActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.action_goal.goal.action))
      _x = self.action_goal.goal.database_path
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.action,) = _struct_B.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.database_path = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.database_path = str[start:end]
      _x = self
      start = end
      end += 12
