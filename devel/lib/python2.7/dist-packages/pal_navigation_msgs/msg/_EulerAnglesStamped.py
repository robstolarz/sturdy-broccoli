...
"""autogenerated by genpy from pal_navigation_msgs/EulerAnglesStamped.msg. Do not edit."""
import sys
...
class EulerAnglesStamped(genpy.Message):
  _md5sum = "08ed1513cf62c3aa9d3f21c206745853"
  _type = "pal_navigation_msgs/EulerAnglesStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','pal_navigation_msgs/EulerAngles']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.angles is None:
        self.angles = pal_navigation_msgs.msg.EulerAngles()
    else:
      self.header = std_msgs.msg.Header()
      self.angles = pal_navigation_msgs.msg.EulerAngles()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.angles.sequence = str[start:end].decode('utf-8')
      else:
