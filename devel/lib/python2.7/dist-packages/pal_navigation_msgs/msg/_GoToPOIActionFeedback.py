...
"""autogenerated by genpy from pal_navigation_msgs/GoToPOIActionFeedback.msg. Do not edit."""
import sys
...
class GoToPOIActionFeedback(genpy.Message):
  _md5sum = "7d1870ff6e0decea702b943b5af0b42e"
  _type = "pal_navigation_msgs/GoToPOIActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_navigation_msgs/GoToPOIFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToPOIActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pal_navigation_msgs.msg.GoToPOIFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pal_navigation_msgs.msg.GoToPOIFeedback()
