...
"""autogenerated by genpy from pal_navigation_msgs/GoToActionFeedback.msg. Do not edit."""
import sys
...
class GoToActionFeedback(genpy.Message):
  ...
  _type = "pal_navigation_msgs/GoToActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_navigation_msgs/GoToFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = pal_navigation_msgs.msg.GoToFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pal_navigation_msgs.msg.GoToFeedback()
