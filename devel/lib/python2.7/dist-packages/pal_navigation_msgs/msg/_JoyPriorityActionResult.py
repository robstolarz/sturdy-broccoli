...
"""autogenerated by genpy from pal_navigation_msgs/JoyPriorityActionResult.msg. Do not edit."""
import sys
...
class JoyPriorityActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pal_navigation_msgs/JoyPriorityActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_navigation_msgs/JoyPriorityResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JoyPriorityActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_navigation_msgs.msg.JoyPriorityResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_navigation_msgs.msg.JoyPriorityResult()
