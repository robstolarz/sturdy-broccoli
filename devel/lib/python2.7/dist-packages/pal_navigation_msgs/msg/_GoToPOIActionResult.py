...
"""autogenerated by genpy from pal_navigation_msgs/GoToPOIActionResult.msg. Do not edit."""
import sys
...
class GoToPOIActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pal_navigation_msgs/GoToPOIActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_navigation_msgs/GoToPOIResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToPOIActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_navigation_msgs.msg.GoToPOIResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_navigation_msgs.msg.GoToPOIResult()
