...
"""autogenerated by genpy from pal_navigation_msgs/JoyTurboActionResult.msg. Do not edit."""
import sys
...
class JoyTurboActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pal_navigation_msgs/JoyTurboActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_navigation_msgs/JoyTurboResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JoyTurboActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_navigation_msgs.msg.JoyTurboResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_navigation_msgs.msg.JoyTurboResult()
