...
"""autogenerated by genpy from pal_navigation_msgs/GoToPOIAction.msg. Do not edit."""
import sys
...
class GoToPOIAction(genpy.Message):
  _md5sum = "3e57adffa446637a9d3969cacf5b458f"
  _type = "pal_navigation_msgs/GoToPOIAction"
...
"""
  ...
  _slot_types = ['pal_navigation_msgs/GoToPOIActionGoal','pal_navigation_msgs/GoToPOIActionResult','pal_navigation_msgs/GoToPOIActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToPOIAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pal_navigation_msgs.msg.GoToPOIActionGoal()
      if self.action_result is None:
        self.action_result = pal_navigation_msgs.msg.GoToPOIActionResult()
      if self.action_feedback is None:
        self.action_feedback = pal_navigation_msgs.msg.GoToPOIActionFeedback()
    else:
      self.action_goal = pal_navigation_msgs.msg.GoToPOIActionGoal()
      self.action_result = pal_navigation_msgs.msg.GoToPOIActionResult()
      self.action_feedback = pal_navigation_msgs.msg.GoToPOIActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.poi.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.poi.data = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.poi.data = str[start:end]
      _x = self
      start = end
      end += 12
