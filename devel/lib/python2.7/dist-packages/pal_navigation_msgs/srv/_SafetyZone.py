...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3dI.pack(_x.distance, _x.leftAngleRad, _x.rightAngleRad, _x.sensorMask))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.distance, _x.leftAngleRad, _x.rightAngleRad, _x.sensorMask,) = _struct_3dI.unpack(str[start:end])
      return self
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B2dB2d.pack(_x.leftSafe, _x.leftMinDist, _x.leftMinDistAngleRad, _x.rightSafe, _x.rightMinDist, _x.rightMinDistAngleRad))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.leftSafe, _x.leftMinDist, _x.leftMinDistAngleRad, _x.rightSafe, _x.rightMinDist, _x.rightMinDistAngleRad,) = _struct_B2dB2d.unpack(str[start:end])
