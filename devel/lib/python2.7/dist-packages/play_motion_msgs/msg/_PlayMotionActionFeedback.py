...
"""autogenerated by genpy from play_motion_msgs/PlayMotionActionFeedback.msg. Do not edit."""
import sys
...
class PlayMotionActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "play_motion_msgs/PlayMotionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','play_motion_msgs/PlayMotionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayMotionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = play_motion_msgs.msg.PlayMotionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = play_motion_msgs.msg.PlayMotionFeedback()
