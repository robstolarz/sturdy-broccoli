...
"""autogenerated by genpy from play_motion_msgs/PlayMotionActionResult.msg. Do not edit."""
import sys
...
class PlayMotionActionResult(genpy.Message):
  _md5sum = "99680b95d3bd3f96e403ed053918b8d1"
  _type = "play_motion_msgs/PlayMotionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','play_motion_msgs/PlayMotionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlayMotionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = play_motion_msgs.msg.PlayMotionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = play_motion_msgs.msg.PlayMotionResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.error_code,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
