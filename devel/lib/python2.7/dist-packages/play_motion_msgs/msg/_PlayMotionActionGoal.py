...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_Bi.pack(_x.goal.skip_planning, _x.goal.priority))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.motion_name = str[start:end].decode('utf-8')
      else:
        self.goal.motion_name = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.goal.skip_planning, _x.goal.priority,) = _struct_Bi.unpack(str[start:end])
