...
"""autogenerated by genpy from pal_behaviour_msgs/PresentationAction.msg. Do not edit."""
import sys
...
class PresentationAction(genpy.Message):
  _md5sum = "63f60f48a3f16a733bd5e4982af38eb2"
  _type = "pal_behaviour_msgs/PresentationAction"
...
"""
  ...
  _slot_types = ['pal_behaviour_msgs/PresentationActionGoal','pal_behaviour_msgs/PresentationActionResult','pal_behaviour_msgs/PresentationActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PresentationAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pal_behaviour_msgs.msg.PresentationActionGoal()
      if self.action_result is None:
        self.action_result = pal_behaviour_msgs.msg.PresentationActionResult()
      if self.action_feedback is None:
        self.action_feedback = pal_behaviour_msgs.msg.PresentationActionFeedback()
    else:
      self.action_goal = pal_behaviour_msgs.msg.PresentationActionGoal()
      self.action_result = pal_behaviour_msgs.msg.PresentationActionResult()
      self.action_feedback = pal_behaviour_msgs.msg.PresentationActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.presentationFile
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.presentationFile = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.presentationFile = str[start:end]
      _x = self
      start = end
      end += 12
