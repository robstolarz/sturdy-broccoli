...
"""autogenerated by genpy from pal_behaviour_msgs/PresentationActionResult.msg. Do not edit."""
import sys
...
class PresentationActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "pal_behaviour_msgs/PresentationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_behaviour_msgs/PresentationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PresentationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_behaviour_msgs.msg.PresentationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_behaviour_msgs.msg.PresentationResult()
