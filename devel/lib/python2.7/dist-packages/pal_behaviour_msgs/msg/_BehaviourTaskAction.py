...
"""autogenerated by genpy from pal_behaviour_msgs/BehaviourTaskAction.msg. Do not edit."""
import sys
...
class BehaviourTaskAction(genpy.Message):
  _md5sum = "5d919a3d8a48d1c701d6fe0123779cb7"
  _type = "pal_behaviour_msgs/BehaviourTaskAction"
...
"""
  ...
  _slot_types = ['pal_behaviour_msgs/BehaviourTaskActionGoal','pal_behaviour_msgs/BehaviourTaskActionResult','pal_behaviour_msgs/BehaviourTaskActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BehaviourTaskAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pal_behaviour_msgs.msg.BehaviourTaskActionGoal()
      if self.action_result is None:
        self.action_result = pal_behaviour_msgs.msg.BehaviourTaskActionResult()
      if self.action_feedback is None:
        self.action_feedback = pal_behaviour_msgs.msg.BehaviourTaskActionFeedback()
    else:
      self.action_goal = pal_behaviour_msgs.msg.BehaviourTaskActionGoal()
      self.action_result = pal_behaviour_msgs.msg.BehaviourTaskActionResult()
      self.action_feedback = pal_behaviour_msgs.msg.BehaviourTaskActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.taskName
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.arguments)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.arguments:
        _x = val1.key
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.taskName = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.taskName = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.arguments = []
      for i in range(0, length):
        ...
        self.action_goal.goal.arguments.append(val1)
      _x = self
      start = end
      end += 12
