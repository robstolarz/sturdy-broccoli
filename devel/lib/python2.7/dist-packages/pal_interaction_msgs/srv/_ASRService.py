...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sb'%length
      buff.write(struct.pack(pattern, *self.request.requests))
      _x = self
      buff.write(_struct_2b.pack(_x.request.activation.action, _x.request.model.action))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.request.requests = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 2
      (_x.request.activation.action, _x.request.model.action,) = _struct_2b.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.request.model.modelName = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.request.lang.language = str[start:end].decode('utf-8')
      else:
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_B.pack(self.response.status.active))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_I2bHb.pack(_x.response.status.device.sample_rate, _x.response.status.device.sample_size, _x.response.status.device.format, _x.response.status.device.buffer_size, _x.response.status.device.number_of_channels))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.response.status.active,) = _struct_B.unpack(str[start:end])
      ...
      if python3:
        self.response.status.language = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.response.status.enabled_grammar = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.response.status.acoustic_env = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.response.status.device.device_name = str[start:end].decode('utf-8')
      else:
        self.response.status.device.device_name = str[start:end]
      _x = self
      start = end
      end += 9
      (_x.response.status.device.sample_rate, _x.response.status.device.sample_size, _x.response.status.device.format, _x.response.status.device.buffer_size, _x.response.status.device.number_of_channels,) = _struct_I2bHb.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.response.error_msg = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.response.warn_msg = str[start:end].decode('utf-8')
      else:
