...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.wait_before_speaking))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.text.section = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.text.key = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.text.lang_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.rawtext.text = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.rawtext.lang_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.speakerName = str[start:end].decode('utf-8')
      else:
        self.speakerName = str[start:end]
      start = end
      end += 8
      (self.wait_before_speaking,) = _struct_d.unpack(str[start:end])
      return self
