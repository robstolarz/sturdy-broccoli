...
"""autogenerated by genpy from pal_interaction_msgs/ASRFileActionFeedback.msg. Do not edit."""
import sys
...
class ASRFileActionFeedback(genpy.Message):
  _md5sum = "88e8c02ba96b633e07aaccac2c11609c"
  _type = "pal_interaction_msgs/ASRFileActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_interaction_msgs/ASRFileFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ASRFileActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pal_interaction_msgs.msg.ASRFileFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pal_interaction_msgs.msg.ASRFileFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.recognised_utterance.text
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_b4I.pack(_x.feedback.recognised_utterance.confidence, _x.feedback.recognised_utterance.start.secs, _x.feedback.recognised_utterance.start.nsecs, _x.feedback.recognised_utterance.end.secs, _x.feedback.recognised_utterance.end.nsecs))
      length = len(self.feedback.recognised_utterance.tags)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.recognised_utterance.tags:
        _x = val1.key
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.recognised_utterance.text = str[start:end].decode('utf-8')
      else:
        self.feedback.recognised_utterance.text = str[start:end]
      _x = self
      start = end
      end += 17
      (_x.feedback.recognised_utterance.confidence, _x.feedback.recognised_utterance.start.secs, _x.feedback.recognised_utterance.start.nsecs, _x.feedback.recognised_utterance.end.secs, _x.feedback.recognised_utterance.end.nsecs,) = _struct_b4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.recognised_utterance.tags = []
      for i in range(0, length):
        ...
        self.feedback.recognised_utterance.tags.append(val1)
      return self
