...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_I2bHb.pack(_x.device.sample_rate, _x.device.sample_size, _x.device.format, _x.device.buffer_size, _x.device.number_of_channels))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.enabled_grammar = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.acoustic_env = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.device.device_name = str[start:end].decode('utf-8')
      else:
        self.device.device_name = str[start:end]
      _x = self
      start = end
      end += 9
      (_x.device.sample_rate, _x.device.sample_size, _x.device.format, _x.device.buffer_size, _x.device.number_of_channels,) = _struct_I2bHb.unpack(str[start:end])
      return self
