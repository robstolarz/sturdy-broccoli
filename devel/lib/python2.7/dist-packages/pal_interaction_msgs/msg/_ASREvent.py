...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2b.pack(_x.event_id, _x.listen_state))
      ...
      _x = self
      buff.write(_struct_b4I.pack(_x.recognized_utterance.confidence, _x.recognized_utterance.start.secs, _x.recognized_utterance.start.nsecs, _x.recognized_utterance.end.secs, _x.recognized_utterance.end.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.event_id, _x.listen_state,) = _struct_2b.unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.recognized_utterance.text = str[start:end].decode('utf-8')
      else:
        self.recognized_utterance.text = str[start:end]
      _x = self
      start = end
      end += 17
      (_x.recognized_utterance.confidence, _x.recognized_utterance.start.secs, _x.recognized_utterance.start.nsecs, _x.recognized_utterance.end.secs, _x.recognized_utterance.end.nsecs,) = _struct_b4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
