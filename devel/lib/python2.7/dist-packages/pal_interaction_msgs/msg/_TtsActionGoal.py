...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.goal.wait_before_speaking))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.text.section = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.text.key = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.text.lang_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.rawtext.text = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.rawtext.lang_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.goal.speakerName = str[start:end].decode('utf-8')
      else:
        self.goal.speakerName = str[start:end]
      start = end
      end += 8
      (self.goal.wait_before_speaking,) = _struct_d.unpack(str[start:end])
      return self
