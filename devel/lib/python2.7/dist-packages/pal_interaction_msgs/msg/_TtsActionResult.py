...
"""autogenerated by genpy from pal_interaction_msgs/TtsActionResult.msg. Do not edit."""
import sys
...
class TtsActionResult(genpy.Message):
  _md5sum = "221e53027c3cef1d5af46761df78a1a3"
  _type = "pal_interaction_msgs/TtsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_interaction_msgs/TtsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TtsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_interaction_msgs.msg.TtsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_interaction_msgs.msg.TtsResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.msg = str[start:end].decode('utf-8')
      else:
