...
class TtsActionFeedback(genpy.Message):
  _md5sum = "7072edb47a2e0ad333b54447f4298ed0"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_H2I.pack(_x.feedback.event_type, _x.feedback.timestamp.secs, _x.feedback.timestamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.event_type, _x.feedback.timestamp.secs, _x.feedback.timestamp.nsecs,) = _struct_H2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.feedback.text_said = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.feedback.next_word = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.feedback.marks.id = str[start:end].decode('utf-8')
      else:
