...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_b4I.pack(_x.confidence, _x.start.secs, _x.start.nsecs, _x.end.secs, _x.end.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.confidence, _x.start.secs, _x.start.nsecs, _x.end.secs, _x.end.nsecs,) = _struct_b4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.tags = []
