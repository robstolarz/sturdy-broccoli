...
"""autogenerated by genpy from pal_interaction_msgs/SoundAction.msg. Do not edit."""
import sys
...
class SoundAction(genpy.Message):
  _md5sum = "8f204dc713899e4882f25f874e54b05b"
  _type = "pal_interaction_msgs/SoundAction"
...
"""
  ...
  _slot_types = ['pal_interaction_msgs/SoundActionGoal','pal_interaction_msgs/SoundActionResult','pal_interaction_msgs/SoundActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SoundAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = pal_interaction_msgs.msg.SoundActionGoal()
      if self.action_result is None:
        self.action_result = pal_interaction_msgs.msg.SoundActionResult()
      if self.action_feedback is None:
        self.action_feedback = pal_interaction_msgs.msg.SoundActionFeedback()
    else:
      self.action_goal = pal_interaction_msgs.msg.SoundActionGoal()
      self.action_result = pal_interaction_msgs.msg.SoundActionResult()
      self.action_feedback = pal_interaction_msgs.msg.SoundActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i3I.pack(_x.action_goal.goal.wait_before_speaking.secs, _x.action_goal.goal.wait_before_speaking.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.text = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.text = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_goal.goal.wait_before_speaking.secs, _x.action_goal.goal.wait_before_speaking.nsecs, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
