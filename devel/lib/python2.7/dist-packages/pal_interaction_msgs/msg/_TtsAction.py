...
class TtsAction(genpy.Message):
  _md5sum = "e600bc3d0229546f8166162383b48288"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_goal.goal.wait_before_speaking, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_H2I.pack(_x.action_feedback.feedback.event_type, _x.action_feedback.feedback.timestamp.secs, _x.action_feedback.feedback.timestamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.text.section = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.text.key = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.text.lang_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.rawtext.text = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.rawtext.lang_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.speakerName = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.speakerName = str[start:end]
      _x = self
      start = end
      end += 20
      (_x.action_goal.goal.wait_before_speaking, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.event_type, _x.action_feedback.feedback.timestamp.secs, _x.action_feedback.feedback.timestamp.nsecs,) = _struct_H2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_feedback.feedback.text_said = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_feedback.feedback.next_word = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_feedback.feedback.marks.id = str[start:end].decode('utf-8')
      else:
