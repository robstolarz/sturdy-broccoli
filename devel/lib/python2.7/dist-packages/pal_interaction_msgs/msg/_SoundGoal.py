...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i.pack(_x.wait_before_speaking.secs, _x.wait_before_speaking.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.wait_before_speaking.secs, _x.wait_before_speaking.nsecs,) = _struct_2i.unpack(str[start:end])
