...
"""autogenerated by genpy from pal_interaction_msgs/ASRFileAction.msg. Do not edit."""
import sys
...
class ASRFileAction(genpy.Message):
  _md5sum = "755ced780decb7cb4a33fd3b127d2d2e"
  _type = "pal_interaction_msgs/ASRFileAction"
...
"""
  ...
  _slot_types = ['pal_interaction_msgs/ASRFileActionGoal','pal_interaction_msgs/ASRFileActionResult','pal_interaction_msgs/ASRFileActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ASRFileAction, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.lang_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.grammar
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.file
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.recognised_utterances)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.recognised_utterances:
        _x = val1.text
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_b.pack(val1.confidence))
        _v1 = val1.start
        _x = _v1
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.recognised_utterance.text
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_b4I.pack(_x.action_feedback.feedback.recognised_utterance.confidence, _x.action_feedback.feedback.recognised_utterance.start.secs, _x.action_feedback.feedback.recognised_utterance.start.nsecs, _x.action_feedback.feedback.recognised_utterance.end.secs, _x.action_feedback.feedback.recognised_utterance.end.nsecs))
      length = len(self.action_feedback.feedback.recognised_utterance.tags)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_feedback.feedback.recognised_utterance.tags:
        _x = val1.key
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.file = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.lang_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_goal.goal.grammar = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_result.result.file = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_result.result.msg = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        ...
        (val1.confidence,) = _struct_b.unpack(str[start:end])
        _v3 = val1.start
        _x = _v3
        start = end
        end += 8
      ...
      if python3:
        self.action_feedback.feedback.recognised_utterance.text = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.recognised_utterance.text = str[start:end]
      _x = self
      start = end
      end += 17
      (_x.action_feedback.feedback.recognised_utterance.confidence, _x.action_feedback.feedback.recognised_utterance.start.secs, _x.action_feedback.feedback.recognised_utterance.start.nsecs, _x.action_feedback.feedback.recognised_utterance.end.secs, _x.action_feedback.feedback.recognised_utterance.end.nsecs,) = _struct_b4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.action_feedback.feedback.recognised_utterance.tags.append(val1)
      return self
