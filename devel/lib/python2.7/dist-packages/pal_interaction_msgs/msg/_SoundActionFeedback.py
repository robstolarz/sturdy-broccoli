...
"""autogenerated by genpy from pal_interaction_msgs/SoundActionFeedback.msg. Do not edit."""
import sys
...
class SoundActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "pal_interaction_msgs/SoundActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_interaction_msgs/SoundFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SoundActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pal_interaction_msgs.msg.SoundFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pal_interaction_msgs.msg.SoundFeedback()
