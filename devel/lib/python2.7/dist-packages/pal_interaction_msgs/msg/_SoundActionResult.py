...
"""autogenerated by genpy from pal_interaction_msgs/SoundActionResult.msg. Do not edit."""
import sys
...
class SoundActionResult(genpy.Message):
  _md5sum = "3fb2b9cd9cec6b4cb23b224521dd7679"
  _type = "pal_interaction_msgs/SoundActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_interaction_msgs/SoundResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SoundActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_interaction_msgs.msg.SoundResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_interaction_msgs.msg.SoundResult()
