...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_b4I.pack(_x.recognised_utterance.confidence, _x.recognised_utterance.start.secs, _x.recognised_utterance.start.nsecs, _x.recognised_utterance.end.secs, _x.recognised_utterance.end.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.recognised_utterance.text = str[start:end].decode('utf-8')
      else:
        self.recognised_utterance.text = str[start:end]
      _x = self
      start = end
      end += 17
      (_x.recognised_utterance.confidence, _x.recognised_utterance.start.secs, _x.recognised_utterance.start.nsecs, _x.recognised_utterance.end.secs, _x.recognised_utterance.end.nsecs,) = _struct_b4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
