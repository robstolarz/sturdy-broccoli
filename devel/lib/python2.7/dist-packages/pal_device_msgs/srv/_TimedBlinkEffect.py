...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I8f6iB.pack(_x.leds.ledMask, _x.firstColor.r, _x.firstColor.g, _x.firstColor.b, _x.firstColor.a, _x.secondColor.r, _x.secondColor.g, _x.secondColor.b, _x.secondColor.a, _x.firstColorDuration.secs, _x.firstColorDuration.nsecs, _x.secondColorDuration.secs, _x.secondColorDuration.nsecs, _x.effectDuration.secs, _x.effectDuration.nsecs, _x.priority))
