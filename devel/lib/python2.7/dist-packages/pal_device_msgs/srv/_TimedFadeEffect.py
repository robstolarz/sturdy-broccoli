...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I8f2iB2iB.pack(_x.leds.ledMask, _x.firstColor.r, _x.firstColor.g, _x.firstColor.b, _x.firstColor.a, _x.secondColor.r, _x.secondColor.g, _x.secondColor.b, _x.secondColor.a, _x.colorChangeDuration.secs, _x.colorChangeDuration.nsecs, _x.reverseFade, _x.effectDuration.secs, _x.effectDuration.nsecs, _x.priority))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.leds.ledMask, _x.firstColor.r, _x.firstColor.g, _x.firstColor.b, _x.firstColor.a, _x.secondColor.r, _x.secondColor.g, _x.secondColor.b, _x.secondColor.a, _x.colorChangeDuration.secs, _x.colorChangeDuration.nsecs, _x.reverseFade, _x.effectDuration.secs, _x.effectDuration.nsecs, _x.priority,) = _struct_I8f2iB2iB.unpack(str[start:end])
