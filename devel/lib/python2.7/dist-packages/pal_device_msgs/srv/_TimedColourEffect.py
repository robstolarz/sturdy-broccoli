...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I4f2iB.pack(_x.leds.ledMask, _x.color.r, _x.color.g, _x.color.b, _x.color.a, _x.effectDuration.secs, _x.effectDuration.nsecs, _x.priority))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.leds.ledMask, _x.color.r, _x.color.g, _x.color.b, _x.color.a, _x.effectDuration.secs, _x.effectDuration.nsecs, _x.priority,) = _struct_I4f2iB.unpack(str[start:end])
