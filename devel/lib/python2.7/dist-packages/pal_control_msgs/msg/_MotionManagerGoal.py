...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4Bi.pack(_x.plan, _x.checkSafety, _x.repeat, _x.priority, _x.queueTimeout))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.plan, _x.checkSafety, _x.repeat, _x.priority, _x.queueTimeout,) = _struct_4Bi.unpack(str[start:end])
