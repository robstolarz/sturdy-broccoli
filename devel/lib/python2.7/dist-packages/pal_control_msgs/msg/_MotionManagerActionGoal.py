...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4Bi.pack(_x.goal.plan, _x.goal.checkSafety, _x.goal.repeat, _x.goal.priority, _x.goal.queueTimeout))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.filename = str[start:end].decode('utf-8')
      else:
        self.goal.filename = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.goal.plan, _x.goal.checkSafety, _x.goal.repeat, _x.goal.priority, _x.goal.queueTimeout,) = _struct_4Bi.unpack(str[start:end])
