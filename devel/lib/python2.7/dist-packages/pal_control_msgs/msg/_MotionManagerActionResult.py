...
"""autogenerated by genpy from pal_control_msgs/MotionManagerActionResult.msg. Do not edit."""
import sys
...
class MotionManagerActionResult(genpy.Message):
  _md5sum = "3fa2b15df3c07c71945669df816f357b"
  _type = "pal_control_msgs/MotionManagerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_control_msgs/MotionManagerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MotionManagerActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = pal_control_msgs.msg.MotionManagerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = pal_control_msgs.msg.MotionManagerResult()
