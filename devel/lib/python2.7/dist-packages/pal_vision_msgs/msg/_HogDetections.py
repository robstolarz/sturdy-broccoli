  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.persons:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.pack(pattern, *val1.rgbDescriptor1))
        length = len(val1.rgbDescriptor2)
        buff.write(_struct_I.pack(length))
        pattern = '<%sI'%length
        buff.write(struct.pack(pattern, *val1.rgbDescriptor2))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.rgbDescriptor1 = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sI'%length
        ...
        val1.rgbDescriptor2 = struct.unpack(pattern, str[start:end])
