...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3d4q.pack(_x.position3D.x, _x.position3D.y, _x.position3D.z, _x.imageBoundingBox.x, _x.imageBoundingBox.y, _x.imageBoundingBox.width, _x.imageBoundingBox.height))
      length = len(self.hog)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.position3D.x, _x.position3D.y, _x.position3D.z, _x.imageBoundingBox.x, _x.imageBoundingBox.y, _x.imageBoundingBox.width, _x.imageBoundingBox.height,) = _struct_3d4q.unpack(str[start:end])
      start = end
      end += 4
