...
"""autogenerated by genpy from pal_vision_msgs/FaceRecognitionActionFeedback.msg. Do not edit."""
import sys
...
class FaceRecognitionActionFeedback(genpy.Message):
  _md5sum = "09c43b79bb624f9ee31bc35a9acf412e"
  _type = "pal_vision_msgs/FaceRecognitionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','pal_vision_msgs/FaceRecognitionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FaceRecognitionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = pal_vision_msgs.msg.FaceRecognitionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = pal_vision_msgs.msg.FaceRecognitionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.feedback.names:
        length = len(val1)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.order_id,) = _struct_B.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.feedback.names = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.feedback.names.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.feedback.confidence = struct.unpack(pattern, str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.feedback.confidence = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
