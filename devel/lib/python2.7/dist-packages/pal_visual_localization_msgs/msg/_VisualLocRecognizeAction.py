...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_Bd3I.pack(_x.action_result.result.success, _x.action_result.result.confidence, _x.action_result.result.estimatedPose.header.seq, _x.action_result.result.estimatedPose.header.stamp.secs, _x.action_result.result.estimatedPose.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.action_result.result.estimatedPose.pose.pose.position.x, _x.action_result.result.estimatedPose.pose.pose.position.y, _x.action_result.result.estimatedPose.pose.pose.position.z, _x.action_result.result.estimatedPose.pose.pose.orientation.x, _x.action_result.result.estimatedPose.pose.pose.orientation.y, _x.action_result.result.estimatedPose.pose.pose.orientation.z, _x.action_result.result.estimatedPose.pose.pose.orientation.w))
      buff.write(_struct_36d.pack(*self.action_result.result.estimatedPose.pose.covariance))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.success, _x.action_result.result.confidence, _x.action_result.result.estimatedPose.header.seq, _x.action_result.result.estimatedPose.header.stamp.secs, _x.action_result.result.estimatedPose.header.stamp.nsecs,) = _struct_Bd3I.unpack(str[start:end])
      ...
      if python3:
        self.action_result.result.estimatedPose.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_result.result.estimatedPose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 56
      (_x.action_result.result.estimatedPose.pose.pose.position.x, _x.action_result.result.estimatedPose.pose.pose.position.y, _x.action_result.result.estimatedPose.pose.pose.position.z, _x.action_result.result.estimatedPose.pose.pose.orientation.x, _x.action_result.result.estimatedPose.pose.pose.orientation.y, _x.action_result.result.estimatedPose.pose.pose.orientation.z, _x.action_result.result.estimatedPose.pose.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      start = end
      end += 288
      self.action_result.result.estimatedPose.pose.covariance = _struct_36d.unpack(str[start:end])
      _x = self
      start = end
      end += 12
