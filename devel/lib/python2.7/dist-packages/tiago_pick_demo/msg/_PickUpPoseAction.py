...
"""autogenerated by genpy from tiago_pick_demo/PickUpPoseAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import tiago_pick_demo.msg
import geometry_msgs.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class PickUpPoseAction(genpy.Message):
  _md5sum = "8e8c1679c6712e2937cfc19e6ab86b6e"
  _type = "tiago_pick_demo/PickUpPoseAction"
...
"""
  ...
  _slot_types = ['tiago_pick_demo/PickUpPoseActionGoal','tiago_pick_demo/PickUpPoseActionResult','tiago_pick_demo/PickUpPoseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PickUpPoseAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = tiago_pick_demo.msg.PickUpPoseActionGoal()
      if self.action_result is None:
        self.action_result = tiago_pick_demo.msg.PickUpPoseActionResult()
      if self.action_feedback is None:
        self.action_feedback = tiago_pick_demo.msg.PickUpPoseActionFeedback()
    else:
      self.action_goal = tiago_pick_demo.msg.PickUpPoseActionGoal()
      self.action_result = tiago_pick_demo.msg.PickUpPoseActionResult()
      self.action_feedback = tiago_pick_demo.msg.PickUpPoseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_goal.goal.object_pose.header.seq, _x.action_goal.goal.object_pose.header.stamp.secs, _x.action_goal.goal.object_pose.header.stamp.nsecs))
      _x = self.action_goal.goal.object_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_goal.goal.object_pose.pose.position.x, _x.action_goal.goal.object_pose.pose.position.y, _x.action_goal.goal.object_pose.pose.position.z, _x.action_goal.goal.object_pose.pose.orientation.x, _x.action_goal.goal.object_pose.pose.orientation.y, _x.action_goal.goal.object_pose.pose.orientation.z, _x.action_goal.goal.object_pose.pose.orientation.w, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.object_pose.header.seq, _x.action_goal.goal.object_pose.header.stamp.secs, _x.action_goal.goal.object_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.object_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.object_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 68
      (_x.action_goal.goal.object_pose.pose.position.x, _x.action_goal.goal.object_pose.pose.position.y, _x.action_goal.goal.object_pose.pose.position.z, _x.action_goal.goal.object_pose.pose.orientation.x, _x.action_goal.goal.object_pose.pose.orientation.y, _x.action_goal.goal.object_pose.pose.orientation.z, _x.action_goal.goal.object_pose.pose.orientation.w, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
