...
"""autogenerated by genpy from tiago_pick_demo/PickUpPoseActionFeedback.msg. Do not edit."""
import sys
...
class PickUpPoseActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "tiago_pick_demo/PickUpPoseActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tiago_pick_demo/PickUpPoseFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PickUpPoseActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = tiago_pick_demo.msg.PickUpPoseFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tiago_pick_demo.msg.PickUpPoseFeedback()
