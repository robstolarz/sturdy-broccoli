...
"""autogenerated by genpy from tiago_pick_demo/PickUpPoseActionResult.msg. Do not edit."""
import sys
...
class PickUpPoseActionResult(genpy.Message):
  _md5sum = "363a8255aae19ae465319475e1a86dad"
  _type = "tiago_pick_demo/PickUpPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tiago_pick_demo/PickUpPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PickUpPoseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tiago_pick_demo.msg.PickUpPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tiago_pick_demo.msg.PickUpPoseResult()
