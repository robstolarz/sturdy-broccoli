  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.controller:
        ...
        buff.write(_struct_B.pack(val1.running))
        _v2 = val1.max_time
        _x = _v2
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
        _v3 = val1.mean_time
        ...
        _x = _v4
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
        buff.write(_struct_i.pack(val1.num_control_loop_overruns))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.running,) = _struct_B.unpack(str[start:end])
        ...
        (val1.num_control_loop_overruns,) = _struct_i.unpack(str[start:end])
