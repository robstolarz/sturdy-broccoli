...
"""autogenerated by genpy from tf_lookup/TfLookupActionResult.msg. Do not edit."""
import sys
...
class TfLookupActionResult(genpy.Message):
  _md5sum = "1dad7a63fd58bdd6e2957b4b78c0111a"
  _type = "tf_lookup/TfLookupActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tf_lookup/TfLookupResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TfLookupActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tf_lookup.msg.TfLookupResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tf_lookup.msg.TfLookupResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.transform.transform.translation.x, _x.result.transform.transform.translation.y, _x.result.transform.transform.translation.z, _x.result.transform.transform.rotation.x, _x.result.transform.transform.rotation.y, _x.result.transform.transform.rotation.z, _x.result.transform.transform.rotation.w,) = _struct_7d.unpack(str[start:end])
      return self
