...
"""autogenerated by genpy from tf_lookup/TfStreamActionFeedback.msg. Do not edit."""
import sys
...
class TfStreamActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "tf_lookup/TfStreamActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tf_lookup/TfStreamFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TfStreamActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = tf_lookup.msg.TfStreamFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tf_lookup.msg.TfStreamFeedback()
