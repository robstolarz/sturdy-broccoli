...
struct PersonDetections_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::pal_detection_msgs::PersonDetection_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::pal_detection_msgs::PersonDetection_<ContainerAllocator> >::other >  _persons_type;
...
struct MD5Sum< ::pal_detection_msgs::PersonDetections_<ContainerAllocator> >
{
  ...
  {
    return "2e9459d911994b1f8ae4e54431f0f631";
  }

  static const char* value(const ::pal_detection_msgs::PersonDetections_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2e9459d911994b1fULL;
  static const uint64_t static_value2 = 0x8ae4e54431f0f631ULL;
};
